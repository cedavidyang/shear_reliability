...
%     f_c_std = 0.2*f_c_mean;
    ...
    for i_factor = 1:nFactor
        gamma_frpb = 1.25;
        [Vtotal_design(i_factor),~,~,~] = Vtotal_HK_design(db_mean, 'W', gamma_frpb, factor(i_factor));
        for i_LD=1:nLD
...
REdata_HK_W = RE;
save('REdata_HK_W_12Frp_detConc.mat', 'REdata_HK_W');
% save('REdata_HK_W_12Frp_125Conc.mat', 'REdata_HK_W');
