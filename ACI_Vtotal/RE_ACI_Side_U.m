...
load db_Side_ACI
load db_U_ACI
[Vpre1, ~, ~, ~] = Vtotal_ACI(db_Side, 'Side');
[Vpre2, ~, ~, ~] = Vtotal_ACI(db_U, 'U');
Vpre = [Vpre1; Vpre2];
Vexp1 = db_Side(:, 21);
Vexp2 = db_U(:, 21);
Vexp = [Vexp1; Vexp2];
...
load db_design_ACI
db_design = [db_design_ACI; db_design_ACI];
...
REdata_ACI_Side_U = RE;
save('REdata_ACI_Side_U_12Frp_detConc.mat', 'REdata_ACI_Side_U');
% save('REdata_ACI_Side_U_12Frp_125Conc.mat', 'REdata_ACI_Side_U');
